...
<div className="w-screen h-full m-auto bg-gray-900 bg-no-repeat bg-cover bg-[url('https://images.unsplash.com/photo-1620121692029-d088224ddc74?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwxNXx8Z3JhcGhpY3MlMjBiYWNrZ3JvdW5kfGVufDB8MHx8fDE3MzUyODE0NTB8MA&ixlib=rb-4.0.3&q=80&w=1080')]">
  <div className="xl:w-[70%] lg:w-[80%] md:w-[90%] m-auto md:px-0 px-4 md:my-10 bg-[#111111] dark:bg-white rounded-xl overflow-hidden">
    {/* What I DO */}
      ...
      <div className="w-full grid md:grid-cols-2 grid-cols-1 gap-4 mt-8">
        ...
        <div className="flex sm:gap-4 gap-2">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-gray-400 dark:text-gray-700">Creating visually appealing and user-centric designs that enhance user
        ...
        <div className="flex sm:gap-4 gap-2">
          ...
          <div className="flex flex-col gap-2">
            <h3 className="text-xl font-semibold text-white dark:text-black">Custom CMS Solutions</h3>
            <p className="text-gray-400 dark:text-gray-700">Building reusable and efficient CMS APIs to simplify website management and
              scalability.</p>
          </div>
        </div>
        {/* 4 */}
        <div className="flex sm:gap-4 gap-2">
          ...
          <div className="flex flex-col gap-2">
            <h3 className="text-xl font-semibold text-white dark:text-black">Mobile App Dev't</h3>
            <p className="text-gray-400 dark:text-gray-700">Designing and developing user-friendly mobile applications for iOS and Android,
        ...
        <div className="flex sm:gap-4 gap-2">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-gray-400 dark:text-gray-700">Creating robust platforms to elevate your online business presence.</p>
          </div>
        </div>
        {/* 6 */}
        <div className="flex sm:gap-4 gap-2">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-gray-400 dark:text-gray-700">Seamlessly connecting systems to enhance functionality and performance.
            </p>
          </div>
        </div>
      </div>
